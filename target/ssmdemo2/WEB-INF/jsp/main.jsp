            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" target="iframe0" href="${pageContext.request.contextPath}/forward?page=customermanage/selectCustomer" data-index="0">查询用户</a>
                        </li>
                        <li>
                            <a class="J_menuItem" target="iframe0" href="${pageContext.request.contextPath}/forward?page=customermanage/addCustomer">添加用户</a>
                        </li>
                        <li>
                            <a class="J_menuItem" target="iframe0" href="${pageContext.request.contextPath}/forward?page=customermanage/updateCustomer">修改用户</a>
                        </li>
                        <li>
